...
public class EntityFactory {
    ...
    public Hydra buildHydra(Position pos) {
        ...
        double recoveramount = config.optDouble("hydra_health_increase_amount", Hydra.RECOVER_AMOUNT);
        double recoverrate = config.optDouble("hydra_health_increase_rate", Hydra.RECOVER_RATE);
        return new Hydra(pos, hydraHealth, hydraAttack, recoverrate, recoveramount);
    }
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double assassinBribeFailRate = config.optDouble("assassin_bribe_fail_rate", Assassin.BRIBE_FAIL_PROB);
    ...
    public MidnightArmour buildMidnightArmour() {
        double midnightAttack = config.optDouble("midnight_armour_attack", MidnightArmour.DEFAULT_MIDNIGHT_ATTACK);
        double midnightDefence = config.optDouble("midnight_armour_defence", MidnightArmour.DEFAULT_MIDNIGHT_DEFENCE);
